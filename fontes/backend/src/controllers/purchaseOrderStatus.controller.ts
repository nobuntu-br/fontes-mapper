...
export class PurchaseOrderStatusController { 
  ...
  async create(req: Request, res: Response){ 
    ...
    const  purchaseOrderStatusService : PurchaseOrderStatusService = new PurchaseOrderStatusService(req.databaseConnection.databaseType, req.databaseConnection.models["purchaseOrderStatus"]); 
